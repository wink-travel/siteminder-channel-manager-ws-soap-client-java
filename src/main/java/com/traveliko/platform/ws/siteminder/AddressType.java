...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AirTravelerType.Address.class,
    com.traveliko.platform.ws.siteminder.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    com.traveliko.platform.ws.siteminder.OffLocationServiceCoreType.Address.class
})

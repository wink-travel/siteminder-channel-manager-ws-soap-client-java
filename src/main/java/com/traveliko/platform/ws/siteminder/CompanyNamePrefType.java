...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AirlinePrefType.VendorPref.class,
    com.traveliko.platform.ws.siteminder.AirSearchPrefsType.VendorPref.class,
    com.traveliko.platform.ws.siteminder.VehicleAvailRQCoreType.VendorPrefs.VendorPref.class
})

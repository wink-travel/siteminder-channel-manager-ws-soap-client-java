...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AreaInfoType.Attractions.Attraction.Contact.class,
    ContactInfoRootType.class,
    com.traveliko.platform.ws.siteminder.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class
})

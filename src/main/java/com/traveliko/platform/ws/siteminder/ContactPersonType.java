...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.HotelRoomListType.Guests.Guest.class,
    com.traveliko.platform.ws.siteminder.HotelRoomListType.MasterContact.class,
    com.traveliko.platform.ws.siteminder.RecipientInfosType.RecipientInfo.class,
    com.traveliko.platform.ws.siteminder.CruiseGuestDetailType.ContactInfo.class
})

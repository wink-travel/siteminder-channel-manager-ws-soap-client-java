...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.CustomerPrimaryAdditionalType.Primary.class,
    com.traveliko.platform.ws.siteminder.CustomerPrimaryAdditionalType.Additional.class
})

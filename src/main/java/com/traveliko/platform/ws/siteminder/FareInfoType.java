...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AirItineraryPricingInfoType.FareInfos.FareInfo.class,
    com.traveliko.platform.ws.siteminder.PTCFareBreakdownType.FareInfo.class
})

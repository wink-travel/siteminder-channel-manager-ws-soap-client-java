...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AirItineraryPricingInfoType.ItinTotalFare.class,
    com.traveliko.platform.ws.siteminder.PTCFareBreakdownType.PassengerFare.class
})

...
@XmlSeeAlso({
    ...
    com.traveliko.platform.ws.siteminder.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.traveliko.platform.ws.siteminder.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    com.traveliko.platform.ws.siteminder.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class,
    VehicleLocationInformationType.class,
    com.traveliko.platform.ws.siteminder.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class
})

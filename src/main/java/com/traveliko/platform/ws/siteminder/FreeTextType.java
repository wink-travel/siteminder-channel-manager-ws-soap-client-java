...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.PTCFareBreakdownType.Endorsements.Endorsement.class,
    com.traveliko.platform.ws.siteminder.TicketingInfoType.TicketAdvisory.class,
    ErrorType.class,
    WarningType.class,
    com.traveliko.platform.ws.siteminder.FareCodeOptionType.FareRemark.class,

...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class,
    com.traveliko.platform.ws.siteminder.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    com.traveliko.platform.ws.siteminder.RestaurantType.MultimediaDescriptions.class
})

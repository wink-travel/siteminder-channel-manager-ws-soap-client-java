...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.InvBlockType.BlockDescriptions.BlockDescription.class,
    com.traveliko.platform.ws.siteminder.CommentType.Comment.class,
    com.traveliko.platform.ws.siteminder.SpecialRequestType.SpecialRequest.class,
    com.traveliko.platform.ws.siteminder.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.traveliko.platform.ws.siteminder.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    DescriptionType.class,
    com.traveliko.platform.ws.siteminder.ProfileType.Comments.Comment.class
})

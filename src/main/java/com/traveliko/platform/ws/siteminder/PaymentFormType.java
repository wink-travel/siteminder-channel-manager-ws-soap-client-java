...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    HotelPaymentFormType.class,
    PaymentResponseType.class,
    com.traveliko.platform.ws.siteminder.CompanyInfoType.PaymentForm.class,
    com.traveliko.platform.ws.siteminder.CustomerType.PaymentForm.class,

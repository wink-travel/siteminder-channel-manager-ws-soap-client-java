...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.VerificationType.PersonName.class,
    com.traveliko.platform.ws.siteminder.ContactsType.Name.class,
    com.traveliko.platform.ws.siteminder.OrganizationType.OrgMemberName.class,
    com.traveliko.platform.ws.siteminder.TravelClubType.ClubMemberName.class
})

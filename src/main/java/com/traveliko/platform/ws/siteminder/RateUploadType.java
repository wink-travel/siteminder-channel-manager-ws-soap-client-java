...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.InvBlockRoomType.RatePlans.RatePlan.class,
    com.traveliko.platform.ws.siteminder.RateAmountMessageType.Rates.Rate.class
})

...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.CruiseGuestDetailType.LinkedTraveler.class,
    com.traveliko.platform.ws.siteminder.CruiseGuestInfoType.LinkedBookings.LinkedBooking.class
})

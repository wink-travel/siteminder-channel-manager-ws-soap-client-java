...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.OTAHotelAvailRS.RoomStays.RoomStay.class,
    com.traveliko.platform.ws.siteminder.RoomStaysType.RoomStay.class,
    com.traveliko.platform.ws.siteminder.HotelRoomListType.RoomStays.RoomStay.class
})

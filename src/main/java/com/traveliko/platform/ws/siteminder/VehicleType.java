...
@XmlSeeAlso({
    com.traveliko.platform.ws.siteminder.VehicleLocationLiabilitiesType.Coverages.Coverage.CoverageFees.CoverageFee.Vehicles.Vehicle.class,
    com.traveliko.platform.ws.siteminder.VehicleLocationVehiclesType.Vehicle.class,
    com.traveliko.platform.ws.siteminder.VehicleRentalTransactionType.Vehicle.class
})
